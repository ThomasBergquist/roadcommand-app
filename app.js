...
var CITY_COORDS = {
  ...
  "seattle":[47.6062,-122.3321],"tacoma":[47.2529,-122.4443],"olympia":[47.0379,-122.9007],
  "bellingham":[48.7519,-122.4787],"everett":[47.9790,-122.2021],"kent":[47.3809,-122.2348],
  "auburn":[47.3073,-122.2285],"renton":[47.4829,-122.2171],"puyallup":[47.1854,-122.2929],
  "bellevue":[47.6101,-122.2015],"marysville":[48.0512,-122.1771],"lynnwood":[47.8209,-122.3151],
  ...
  "chelan":[47.8368,-120.0165],"bingen":[45.7154,-121.4697],"goldendale":[45.8218,-120.8254],
  "sumas":[49.0000,-122.2649],"oroville":[48.9376,-119.4362],"omak":[48.4115,-119.5282],
  "selah":[46.6549,-120.5306],"sunnyside":[46.3243,-119.9107],"prosser":[46.2068,-119.7676],
  // Oregon
  ...
  "gresham":[45.5029,-122.4312],"hillsboro":[45.5229,-122.9898],"beaverton":[45.4871,-122.8037],
  "the dalles":[45.5943,-121.1787],"hood river":[45.7076,-121.5215],"astoria":[46.1882,-123.8313],
  "klamath falls":[42.2249,-121.7817],"burns":[43.5865,-119.0540],"coos bay":[43.3665,-124.2154],
  // Idaho
  ...
  "charlotte":[35.2271,-80.8431],"raleigh":[35.7796,-78.6382],"richmond":[37.5407,-77.4360],
  "baltimore":[39.2904,-76.6122],"philadelphia":[39.9526,-75.1652],"new york":[40.7128,-74.0060],
  "boston":[42.3601,-71.0589],"detroit":[42.3314,-83.0458],"columbus":[39.9612,-82.9988],
  "cleveland":[41.4993,-81.6944],"indianapolis":[39.7684,-86.1581],"milwaukee":[43.0389,-87.9065],
  "louisville":[38.2527,-85.7585],"cincinnati":[39.1031,-84.5120],"pittsburgh":[40.4406,-79.9959],
  "jacksonville":[30.3322,-81.6557],"miami":[25.7617,-80.1918],"tampa":[27.9506,-82.4572],
  "orlando":[28.5383,-81.3792],"new orleans":[29.9511,-90.0715],"little rock":[34.7465,-92.2896],
  "birmingham":[33.5186,-86.8104],"jackson":[32.2988,-90.1848],"des moines":[41.5868,-93.6250],
  "sioux falls":[43.5473,-96.7283],"fargo":[46.8772,-96.7898],"billings":[45.7833,-108.5007],
  "cheyenne":[41.1400,-104.8202],"pueblo":[38.2544,-104.6091],"colorado springs":[38.8339,-104.8214],
  "tucson":[32.2226,-110.9747],"flagstaff":[35.1983,-111.6513],"yuma":[32.6927,-114.6277],
  "spokane":[47.6588,-117.4260],"tri cities":[46.2396,-119.1006]
};
...
function getDeadheadMiles(pickupCity) {
  ...
  // Check CITY_COORDS (includes seed data + session geocodes)
  ...
  // Check persisted geocode cache
  if (!coords && _cityCoordCache[key] && Array.isArray(_cityCoordCache[key])) {
    coords = _cityCoordCache[key];
  }

  if (!coords) {
    // Unknown — geocode in background for next time
    geocodeCityAsync(key, pickupCity);
    return 0;
  }

  // Return driving distance approximation (haversine × 1.25)
  return Math.round(haversineMiles(window._gpsLat, window._gpsLon, coords[0], coords[1]) * 1.25);
}
...
async function fetchTruckstopLoads(forceRefresh) {
  ...
  // Use GPS city if it's a real city, otherwise use home base from settings
  var gpsCity  = currentCity || '';
  var isCounty = gpsCity.toLowerCase().indexOf('county') >= 0 || gpsCity.toLowerCase().indexOf('county') >= 0;
  var homeBase = (document.getElementById('p-home') && document.getElementById('p-home').value.trim()) || '';
  var city     = isCounty ? (homeBase.split(',')[0].trim() || '') : gpsCity;
